  ...
  sidebarLayout(
    ...
    mainPanel(tabsetPanel(
      ...
      tabPanel("Welcome",
               ...
               p("Please refer to this publication for details about the samples and data processing methods 
               ...
               p("This app is developed and maintained by the ",
                 ...
                 Most of the current content was generated by Selin Jessa and Bhavyaa Chandarana. 
                 For suggestions, questions or feedback, please contact ",
